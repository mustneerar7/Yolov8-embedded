...
// Class containing the detection logic.
class Detector(
  ...
  // Close the interpreter. Cleanup function.
  fun clear() {
    interpreter?.close()
    interpreter = null
  }
  ...
  // Find the best bounding boxes by filtering out boxes with low confidence scores.
  ...
  // Non-Maximum Suppression application on bounding boxes.
  ...
  // Provide an interface for the listener to get the results.
